...
<head>
  ...
  <title>Error</title>
      ...
      <link rel="stylesheet" href="errorFE/css/style.css">
...
<div class="text">
  <div class="text-inner">
    <h1> Oopsie! >.< </h1>
	<h1> Esto nos apena </h1>
    <h2> <%if(request.getParameter("e") != null) out.print(request.getParameter("e"));
    		else out.print("No tenemos excusas para ti. Juramos que es la primera vez que sucede"); %> </h2>

	<a href="home" class="nostyle">
	    <div id="home" class="button">
	      <h3 class="noselect"> HOME </h3>
	    </div>
    </a>
	</div>
