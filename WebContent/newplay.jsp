        ...
        <div id="info" style="
          ...
          ">
	          ...
	          <h2>Cargar obra</h2>
				...
				<input type="text" name="name" placeholder="Nombre de la obra" class="round" maxlength="30" required /><br/>
				<input type="text" name="author" placeholder="Autor" class="round" maxlength="30" required /><br/>
				<textarea maxlength="500" rows="4" cols="50" form="form" name="description" placeholder="Descripcion" required></textarea><br/>
				<div class="box">
